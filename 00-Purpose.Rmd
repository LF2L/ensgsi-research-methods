...
* Experience the diversity of options that open practices to communicate your results. 
...
However, this is a first step in order to get competence in the data analysis as it is required in a world of artificial intelligence and huge amount of data. 
